...
const pollApiResponse = {
  ...
  data: {
    ...
    submissionsData: [
      ...
      {
        sectionId: "ce82e5df-e8a2-40f1-8a4d-a2444f76c3ee",
        fieldId: "e17b509c-c9de-4fe6-a7af-853e8422f44c",
        type: "ranking",
        label: "Ranking Labeler",
        totalResponses: 4,
        responsesData: {
          rankings: [
            {
              optionId: "79ba04af-e1cd-4e62-b959-18468a5391aa",
              label: "Option 2",
              value: "option_2",
              count: 4,
              percentage: 100,
            ...
            {
              optionId: "3218eef6-455c-49a1-ab57-9431a169e7ae",
              label: "Option 1",
              value: "option_1",
              count: 4,
              percentage: 100,
